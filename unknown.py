...
class Fast_Cart:
    def __init__(self, top=None):
        ...
        self.TButton1.configure(command=unknown_support.scan_button())
       ...
       # self.ScrolledListBox1 = ScrolledListBox (top)
        ...
        self.Message1.configure(textvariable=unknown_support.total)
        ...
        self.QuanLabel = ttk.Label(top)
        self.QuanLabel.place(relx=0.75, rely=0.42, height=19, width=4)
        self.QuanLabel.configure(background="#d9d9d9")
        self.QuanLabel.configure(foreground="#000000")
        self.QuanLabel.configure(relief=FLAT)
        self.QuanLabel.configure(textvariable=unknown_support.quantity)

        self.QuanButton = ttk.Button(top)
        self.QuanButton.place(relx=0.73, rely=0.48, height=25, width=126)
        self.QuanButton.configure(command=unknown_support.QuanButton())
